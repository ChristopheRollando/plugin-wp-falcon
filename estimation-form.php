<?php
/*
 * Plugin Name: WP Simulation Devis/Facture
 * Version: 1.2
 * Plugin URI: https://christophe-rollando.fr
 * Description: Plugin permettant de simuler un Devis ou une facture en Front Office, création de plusieurs étapes avec Paiement en étape Finale.
 * Author: Christophe Rollando
 * Author URI: https://christophe-rollando.fr
 *
 * @package WordPress
 * @author Christophe Rollando
 * @since 1.0.0
